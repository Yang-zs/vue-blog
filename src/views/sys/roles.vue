  ...
  <div class="role-container">
    ...
    >
      ...
      <el-table-column label="操作" width="250px">
        <template v-slot="scope">
          <el-button size="mini" plain @click="handleOpenDialog(scope.row.id)"
            >编辑</el-button
          >
    ...
    >
      ...
      >
        <el-form-item label="角色" prop="name">
          <el-input
            v-model.trim="RoleDialogForm.name"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="编码" prop="code">
          <el-input
            v-model.trim="RoleDialogForm.code"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="描述" prop="remark">
          <el-input
            v-model.trim="RoleDialogForm.remark"
            autocomplete="off"
          ></el-input>
        </el-form-item>
